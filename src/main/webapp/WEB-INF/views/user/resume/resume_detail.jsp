...
<link
	href="<c:url value='/resources/css/user/resume/resume_detail.css' />"
	...
	<div class="modify_resume_form">
		...
		<form action="<c:url value='/resume/modifyResumeConfirm'/>"
			...
			<h3>이력서 제목</h3>
				...
				value="${resumeVo.r_title }" class="r_title" readonly>
			<h3>학력 사항</h3>
			<div class="r_edu_wrap">
				<h4>최종학력</h4>
				<select name="r_edu" class="r_edu" disabled>
			...
			<div class="career_wrap" >
				<input type="radio" name="r_career" value="신입" ${resumeVo.r_career == '신입' ? 'checked' : ''}
					class="r_career_option new" disabled>신입 <input type="radio"
					name="r_career" value="경력" ${resumeVo.r_career == '경력' ? 'checked' : ''}class="r_career_option old" disabled>경력
				<div class="r_career_date_wrap" >
					<input type="number" name="r_career_date" value="${resumeVo.r_career_date}"
						class="r_career_date" readonly>
					<p id="monthsText">개월</p>
				</div>
			</div>
			<h3>희망근무조건</h3>
			<h4>근무지</h4>
			<select name="r_hope_loc" class="r_hope_loc" disabled>
			...
			<h4>희망업종</h4>
			<select name="r_hope_sct" class="r_hope_sct" disabled>
				<option value=""></option>
				<option value="외식·음료"
			...
			<h4>근무기간</h4>
			<select name="r_hope_prd" class="r_hope_prd" disabled>
				<option value=""></option>
			...
			<h4>근무시간</h4>
			<select name="r_hope_day" class="r_hope_day" disabled>
				<option value=""></option>
			...
			<h4>급여</h4>
			<select name="r_hope_hrd" class="r_hope_hrd" disabled>
				...
				value="${resumeVo.r_hope_pay}" class="r_hope_pay" readonly>원


			<h4>자기소개</h4>
			<textarea name="r_des" placeholder="자기소개서를 작성해주세요(최대3000자)"
				class="r_des" readonly>${resumeVo.r_des}</textarea>
			
			<div class="button_wrap">
				<c:url value='/resume/modifyResumeForm' var='modify_url'>
							<c:param name='r_no' value='${resumeVo.r_no}' />
						</c:url>
						<a class="modify_resume" href="${modify_url}">이력서
								수정</a>
