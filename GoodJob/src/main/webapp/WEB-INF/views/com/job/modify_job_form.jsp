...
<head>
<link href="<c:url value = '/resources/css/com/modifyjobform.css'/>"
	rel="stylesheet" type="text/css">
<meta charset="UTF-8">
<title>채요공고수정하기</title>
<script type="text/javascript">
	function modifyJobForm() {
		console.log('modifyJobForm() CALLED!!');

		let form = document.modify_job_form;
		...
		<div id="section_wrap">
			...
			<div class="modify_job_form">
				...
				<div class="formbox">
					...
					<div>
						<p>연령</p>
						<input type="text" name="rec_age" value="${jobVo.rec_age }">
						</div>
						<br>
					
					<div>
						<p>성별</p>
						<select name="rec_gender">
							<option value="성별"
			...
			<div><p>급여</p>
					<input type="text" name="rec_pay" value="${jobVo.rec_pay }"></div>
					<br>
					<div><p>근무기간</p>
					<br> <select name="rec_prd">
						<option value="경력"
				...
				<div>	<p>직종</p>
					...
					<input type="text" name="rec_bnf" value="${ jobVo.rec_bnf}"
						placeholder="채용공고 복리후생."> </div> <br>
						<input type="button"  class="okbtn"
						value="수정하기" onclick="modifyJobForm();">
					</div>
