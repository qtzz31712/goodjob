...
<link href="<c:url value='/resources/css/com/login_form.css' />" rel="stylesheet" type="text/css">
	...
	<section>
		<div id="section_wrap">
			<div class="login_form">
				...
				<form action="<c:url value='/com/member/loginConfirm' />" name="login_form" method="post">
				<div class="select_id">
				...
				<div>
				<input type="text"		name="c_id" 		placeholder="아이디를 입력하세요."> <br>
				<input type="password"	name="c_pw" 		placeholder="비밀번호를 입력하세요."> <br>
				</div>
			...
			<div class="find_join">
				...
				<a href="<c:url value='/com/member/findPasswordForm' />">비밀번호 찾기</a>
